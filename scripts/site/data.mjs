...
export const CMP = {
  gobbl: { price: "y|Free. AI features free during the beta", oss: "y|Yes, MIT", platforms: "-|macOS 14+", dictation: "y|Yes, Whisper on your Mac (Apple silicon)", cap: "y|None", memory: "y|Yes, opt-in beta, with auto-ticking to-dos", mcp: MCP_LIVE ? "y|Yes, one switch for 9 AI apps (Memory beta)" : "p|Coming soon", agents: "y|Claude Code, Codex and Grok status, Allow/Deny for Claude Code", pet: "y|Yes, Gob", privacy: "y|Local first; AI via a provider that keeps no data; log of every request" },
...
export const FAQ = {
  ...
  "AI agents": [
    ...
    ["Does it work with Codex and Grok?", `Yes, for status: Gob works along while Codex or Grok runs and celebrates when it's done. Allow and Deny from the notch is for Claude Code. Codex runs only hooks you've approved, so after you connect it, approve Gobbl's hooks once: run /hooks in Codex, or open Hooks in Codex's settings in your editor.`],
